...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6 flex items-center gap-2 text-sm text-gray-500">
        ...
        <span class="text-gray-700 font-medium">Tambah Pengemudi</span>
    </div>

    <div class="bg-white rounded-2xl shadow px-8 py-8">
        <h1 class="text-xl font-bold text-gray-800 mb-6">Tambah Data Pengemudi</h1>
        ...
        <form method="POST" action="{{ route('drivers.store') }}" novalidate>
            ...
            <div class="mb-8">
                ...
                @enderror
                <p class="mt-1 text-xs text-gray-400">Status pengemudi akan otomatis diset ke <strong>Tersedia</strong> saat ditambahkan.</p>
            </div>
