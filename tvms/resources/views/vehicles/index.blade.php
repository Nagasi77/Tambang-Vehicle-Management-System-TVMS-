...
<div class="bg-white rounded-2xl shadow overflow-hidden">
    @if ($vehicles->isEmpty())
        <div class="px-6 py-16 text-center text-gray-500">
            ...
            <p class="font-medium">Belum ada data kendaraan.</p>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="inline-flex items-center gap-2">
                                    ...
                                    <form method="POST" action="{{ route('vehicles.destroy', $vehicle->id) }}" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                                onclick="return confirm('Apakah Anda yakin ingin menghapus kendaraan {{ $vehicle->plat_nomor }}? Tindakan ini tidak dapat dibatalkan.')"
