...
@section('title', 'Tambah Servis: ' . $vehicle->plat_nomor)
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Tambah Riwayat Servis</h1>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 px-6 py-8">
        <form method="POST" action="{{ route('vehicles.services.store', $vehicle) }}" novalidate>
            @csrf
