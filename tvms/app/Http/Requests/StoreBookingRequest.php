...
class StoreBookingRequest extends FormRequest
{
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            ...
            if ($conflict = $service->checkVehicleConflict((int) $this->vehicle_id, $start, $end)) {
            ...
            if ($conflict = $service->checkDriverConflict((int) $this->driver_id, $start, $end)) {
                $validator->errors()->add('driver_id',
